                    ...
                    <div className="lg:grid lg:grid-cols-6 gap-20">
                        <div className="col-span-3">
                            <div className="flex items-center space-x-5">
                                ...
                                <p className="font-semibold text-xl text-white">PaBot TR de İlk</p>
                            </div>
                            <Menu as="div" className="relative mt-3 inline-block text-left">
                                <div>
                                    <Menu.Button className="flex z-1 items-center w-full px-4 py-2 text-sm font-medium text-white bg-black rounded-md bg-opacity-20 hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
                                        <img
                                            src={`https://flagpedia.net/data/flags/w80/tr.webp`}
                                            width="24"
                                            height="18"
...
<a href="https://top.gg/bot/1120445148971663460">
  <img src={"https://discord.gg/TUd94KXY5Y"}/>
</a>
<div className="py-1"></div>
<a href="https://top.gg/bot/1120445148971663460">
  <img src={"https://discord.gg/TUd94KXY5Y"}/>
...
<a href="https://top.gg/bot/1120445148971663460">
  <img src={"https://discord.gg/TUd94KXY5Y"}/>
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <Link href="https://top.gg/bot/1120445148971663460">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                                        Botumuzun Mod Versiyonu
                                    </a>
                                </Link>
                            </div>
                            <div>
                                <a href="https://discord.gg/TUd94KXY5Y" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Discord Yedek Sunucumuz
                                </a>
                            </div>
                            <div>
                                <a href=" https://discord.gg/TUd94KXY5Y" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <Link href="https://github.com/Patates3113">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                            ...
                            <div>
                                <Link href="https://youtube.com/patates1313">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                    ...
                    <div className="mt-10 grid content-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                        <p className="text-white text-center sm:text-left text-opacity-50">
                            {new Date().getFullYear()} &copy; PaBot
                        </p>
